...
public class ProductController {
    ...
    public ResponseEntity<Product> getProduct(@PathVariable("idProducto") int productId){
    ...
    public ResponseEntity<List<Product>> getByCategory(@PathVariable("idCategoria") int categoryId){
